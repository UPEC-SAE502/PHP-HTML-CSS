...
{	// debug($_POST);
	...
	executeRequete("REPLACE INTO produit (id_produit, reference, categorie, titre, description, marque, photo, prix) values ('$_POST[id_produit]', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$_POST[marque]',  '$photo_bdd',  '$_POST[prix]')");
...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification'))
{
	...
	<form method="post" enctype="multipart/form-data" action="">
		...
		<input type="text" id="marque" name="marque" placeholder="la marque du produit"  value="'; if(isset($produit_actuel['marque'])) echo $produit_actuel['marque']; echo '" /> <br /><br />
